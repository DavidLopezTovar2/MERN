...
const clientWithIds = clients.map((client, idx) =>{
    return {
        id: client.id
    }
});

console.log(clientWithIds);


const clientWithIdsOverTree = clients.filter(client => client.id > 3);

console.log(clientWithIdsOverTree);
